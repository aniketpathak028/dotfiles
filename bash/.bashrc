...
if [[ "$OSTYPE" == "linux-gnu"* ]]; then
  # Set the ALACRITTY_CONFIG_PATH to point to the directory containing your ubuntu.toml
  export ALACRITTY_CONFIG_PATH="$HOME/dotfiles/alacritty/.config/alacritty/"
  # Create the symlink for Alacritty to find the correct config file.
  # Ensure the target directory exists first.
  mkdir -p ~/.config/alacritty/
  ln -sf ~/dotfiles/alacritty/.config/alacritty/linux.toml ~/.config/alacritty/alacritty.toml
fi
# --- End Alacritty Configuration ---
